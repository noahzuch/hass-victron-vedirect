# Getting Started with Victron VE.Direct

This guide will help you install and set up the Victron VE.Direct custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/noahzuch/hass-victron-vedirect`
6. Set category to "Integration"
7. Click "Add"
8. Find "Victron VE.Direct" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/noahzuch/hass-victron-vedirect/releases)
2. Extract the `victron_vedirect` folder from the archive
3. Copy it to `custom_components/victron_vedirect/` in your Home Assistant configuration directory
...
4. Select entities from "Victron VE.Direct"

Example entities card:

```yaml
type: entities
title: Victron VE.Direct
entities:
...
- Report issues at [GitHub Issues](https://github.com/noahzuch/hass-victron-vedirect/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/noahzuch/hass-victron-vedirect/discussions)
