...
- `VictronVEDirectApiClientError` (Base)
- `VictronVEDirectApiClientCommunicationError` (Network, timeout, HTTP errors)
- `VictronVEDirectApiClientAuthenticationError` (401, 403, invalid credentials)
