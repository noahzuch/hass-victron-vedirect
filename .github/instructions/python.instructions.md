...
- Files: `snake_case.py`
- Classes: `PascalCase` prefixed with `VictronVEDirect`
...
- Inherit from both platform entity and `VictronVEDirectEntity` (order matters)
...
from custom_components.victron_vedirect.sensor import async_setup_entry
...
**Config entry data:** `entry_data: VictronVEDirectData = hass.data[DOMAIN][entry.entry_id]`
