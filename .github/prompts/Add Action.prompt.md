...
**File:** `custom_components/victron_vedirect/services.yaml`
...
Create `custom_components/victron_vedirect/service_actions/[action_name].py`:

```python
"""[Action name] service action for Victron VE.Direct."""
...
**File:** `custom_components/victron_vedirect/__init__.py`
...
**File:** `custom_components/victron_vedirect/const.py`
...
3. Find service action: `victron_vedirect.[action_name]`
...
- **Service actions directory:** `custom_components/victron_vedirect/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/victron_vedirect/services.yaml` (legacy filename)
- **Icons:** `custom_components/victron_vedirect/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/victron_vedirect/translations/*.json` under `services` key (legacy)
