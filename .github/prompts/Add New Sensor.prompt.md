...
- Create new sensor file in `custom_components/victron_vedirect/sensor/`
- Inherit from `VictronVEDirectEntity` and `SensorEntity`
...
```python
"""[Sensor description] for Victron VE.Direct."""
...
class VictronVEDirect[SensorName]Sensor(
...
- Entity: `custom_components/victron_vedirect/sensor/[sensor_name].py`
- Platform: `custom_components/victron_vedirect/sensor/__init__.py`
- Translations: `custom_components/victron_vedirect/translations/*.json`
