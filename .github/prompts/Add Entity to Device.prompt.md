...
- Inherit from `VictronVEDirectEntity` and platform base class
...
- Entity: `custom_components/victron_vedirect/[platform]/[entity_name].py`
- Platform: `custom_components/victron_vedirect/[platform]/__init__.py`
