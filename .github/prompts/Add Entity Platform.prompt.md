...
**Directory:** `custom_components/victron_vedirect/[platform]/`
...
```python
"""[Platform] platform for Victron VE.Direct."""
...
from .entity import VictronVEDirectEntity
from .[entity_file] import VictronVEDirect[EntityName]
from .const import DOMAIN
from .coordinator import VictronVEDirectDataUpdateCoordinator
...
async def async_setup_entry(
    ...
    coordinator: VictronVEDirectDataUpdateCoordinator = hass.data[DOMAIN][
        entry.entry_id
    ]

    async_add_entities(
        [
            VictronVEDirect[EntityName](coordinator, entry),
...
```python
"""[Entity description] for Victron VE.Direct."""
...
class VictronVEDirect[EntityName](
    VictronVEDirectEntity,
    [PlatformEntityClass],
):
    ...
    def __init__(
        self,
        coordinator: VictronVEDirectDataUpdateCoordinator,
        entry: ConfigEntry,
    ) -> None:
...
Add platform to `custom_components/victron_vedirect/manifest.json`:
...
- [ ] Entity class inherits from both `VictronVEDirectEntity` and platform class
...
- **Class prefix:** `VictronVEDirect`
- **Base entity:** `VictronVEDirectEntity` in `entity/base.py`
- **Coordinator:** `VictronVEDirectDataUpdateCoordinator`
