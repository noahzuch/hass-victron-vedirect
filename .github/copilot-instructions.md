...
- **Main code:** `custom_components/victron_vedirect/`
...
- `entity/` — Base entity class (`VictronVEDirectEntity`)
...
- Entity MRO: `(PlatformEntity, VictronVEDirectEntity)` — order matters
...
- Debug level: `custom_components.victron_vedirect: debug` in `config/configuration.yaml`
